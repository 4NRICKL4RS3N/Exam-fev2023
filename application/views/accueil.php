...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/style-accueil.css">
    ...
    <div class="banner_bg_main">
         ...
         <div class="logo_section" >
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo"><a style="color: white; font-family: lemon; font-size: xx-large;" href="index.html">TAKALO-TAKALO</a></div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="header_section" style="padding-bottom: 50px;">
            <div class="container">
